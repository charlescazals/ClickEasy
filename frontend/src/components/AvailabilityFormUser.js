...
export default class AvailabilityForm extends React.Component {
  ...
  componentWillReceiveProps() {
    if (JSON.stringify(this.props.availability) !== JSON.stringify({"morning":{},"day":{},"evening":{},"overnight":{}}) ){
      this.setState({
  ...
  renderBlock (status, shift, day) {
    ...
    return (
      <td key={Math.random()}>
        <button style={style} data-id={shift + '|' + day} onClick={this.handleBlockClick} />
          {/* */}
      </td>
    )
  }
